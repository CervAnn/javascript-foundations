...
describe('Medusa', function() {
  ...
  it('should unstone the first victim and stone the 4th coming in', function() {
    // create medusa
    var medusa = new Medusa('Meeka');
    // create first victim
    var victim1 = new Person('Lousia');
    // create second victim
    var victim2 = new Person('Travis');
    // create third victim
    var victim3 = new Person('Khalid');
    // create fourth victim
    var victim4 = new Person('Jeff');
